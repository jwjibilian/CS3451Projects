...
void draw()      // executed at each frame
  ...
  if(recordingPDF) startRecordingPDF(); // starts recording graphics to make a PDF
    ...
    background(yellow); // clear screen and paints white background
